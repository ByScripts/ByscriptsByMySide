...
class ByMySideTest extends \PHPUnit_Framework_TestCase
{
    public function test()
    {
        ...
        $this->assertEquals(
            '<div class="bymyside-container bymyside-container-left"><div class="bymyside-block bymyside-block-top"><span class="bymyside-item bymyside-item-scheme-blue"><span class="bymyside-item-icon">H</span><span class="bymyside-item-label">Hello</span></span><span class="bymyside-item bymyside-item-scheme-twitter"><span class="bymyside-item-icon">W</span><span class="bymyside-item-label">World</span></span></div><div class="bymyside-block bymyside-block-bottom"><a class="bymyside-item-scheme-default bymyside-item" href="http://foobar"><span class="bymyside-item-icon">H</span><span class="bymyside-item-label">Hello</span></a><span class="bymyside-item-scheme-default bymyside-item"><span class="bymyside-item-icon">W</span><span class="bymyside-item-label">World</span></span></div></div><div class="bymyside-container bymyside-container-right"><div class="bymyside-block bymyside-block-top"><span class="bymyside-item bymyside-item-scheme-red bymyside-item-highlight"><span class="bymyside-item-icon">X</span><span class="bymyside-item-label">Hello</span></span><span class="bymyside-item-scheme-default bymyside-item"><span class="bymyside-item-icon">W</span><span class="bymyside-item-label">World</span></span></div><div class="bymyside-block bymyside-block-bottom"><span class="bymyside-item-scheme-default bymyside-item"><span class="bymyside-item-icon">H</span><span class="bymyside-item-label">Hello</span></span><span class="bymyside-item-scheme-default bymyside-item"><span class="bymyside-item-icon">W</span><span class="bymyside-item-label">World</span></span></div></div>',
            $bms->render()
        );
    }
